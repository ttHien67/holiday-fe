    ...
    const onSubmit = async (data) => {
        try {
            if (data) {
                ...
                toastSuccess(JSON.stringify(document.message));
                handleClearInput();
            }
        } catch (error) {
            toastError(error);
                ...
                <div className="login__wrapper">
                    ...
                    <form className="login__form" onSubmit={handleSubmit(() => onSubmit(account))}>
                        <div className="login__input">
                            ...
                            />
                            {errors.fullName && (
                                <p className="contact__form-input-item-error">{errors.fullName.message}</p>
                            )}
                        </div>
                        ...
                        <div className="login__input-group">
                            ...
                            <div className="login__input">
                                ...
                                />
                                {errors.email && (
                                    <p className="contact__form-input-item-error">{errors.email.message}</p>
                                )}
                            </div>
                        </div>
                        <div className="login__input">
                            ...
                            />
                            {errors.address && (
                                <p className="contact__form-input-item-error">{errors.address.message}</p>
                            )}
                        </div>
                        <div className="login__input">
